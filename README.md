...
**The original Faker is archived**. Read the reasons behind this decision here: [https://marmelab.com/blog/2020/10/21/sunsetting-faker.html](https://marmelab.com/blog/2020/10/21/sunsetting-faker.html) 
...
### Create fake data
Use `Mattsmithdev\FakerSmallEnglish\Factory::create()` to create and initialize a faker generator, which can generate data by accessing properties named after the type of data you want.
...
Even if this example shows a property access, each call to `$faker->name()` yields a different (random) result. This is because Faker uses `__get()` magic, and forwards `Mattsmithdev\FakerSmallEnglish\Generator->$property` calls to `Mattsmithdev\FakerSmallEnglish\Generator->format($property)`.

**IMPORTANT** You'll get deprecation error if you ommit the `()` after the property name ... some of this documentation may be in the form of `->name` instead of `->name()`
...
### `Mattsmithdev\FakerSmallEnglish\Provider\Base`
...
### `Mattsmithdev\FakerSmallEnglish\Provider\Lorem`
...
### `Mattsmithdev\FakerSmallEnglish\Provider\en_US\Person`
...
### `Mattsmithdev\FakerSmallEnglish\Provider\en_US\Address`
...
### `Mattsmithdev\FakerSmallEnglish\Provider\en_US\PhoneNumber`

    phoneNumber             // '201-886-0269 x3767'
    tollFreePhoneNumber     // '(888) 937-7238'
    e164PhoneNumber     // '+27113456789'

### `Mattsmithdev\FakerSmallEnglish\Provider\en_US\Company`
...
### `Mattsmithdev\FakerSmallEnglish\Provider\en_US\Text`

    realText($maxNbChars = 200, $indexSize = 2) // "And yet I wish you could manage it?) 'And what are they made of?' Alice asked in a shrill, passionate voice. 'Would YOU like cats if you were never even spoke to Time!' 'Perhaps not,' Alice replied."

### `Mattsmithdev\FakerSmallEnglish\Provider\DateTime`
...
### `Mattsmithdev\FakerSmallEnglish\Provider\Internet`
...
### `Mattsmithdev\FakerSmallEnglish\Provider\UserAgent`
...
### `Mattsmithdev\FakerSmallEnglish\Provider\Payment`
...
### `Mattsmithdev\FakerSmallEnglish\Provider\Color`
...
### `Mattsmithdev\FakerSmallEnglish\Provider\File`
...
### `Mattsmithdev\FakerSmallEnglish\Provider\Image`
...
### `Mattsmithdev\FakerSmallEnglish\Provider\Uuid`

    uuid                   // '7e57d004-2b97-0e7a-b45f-5387367791cd'

### `Mattsmithdev\FakerSmallEnglish\Provider\Barcode`
...
### `Mattsmithdev\FakerSmallEnglish\Provider\Miscellaneous`
...
### `Mattsmithdev\FakerSmallEnglish\Provider\Biased`

    // get a random number between 10 and 20,
    // with more chances to be close to 20
    biasedNumberBetween($min = 10, $max = 20, $function = 'sqrt')

### `Mattsmithdev\FakerSmallEnglish\Provider\HtmlLorem`
